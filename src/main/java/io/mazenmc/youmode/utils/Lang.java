...
public class Lang {
    ...
    public static final String[] CMDS = generateMessage("&6/ym list - &bList all youtubers/streamers that are recording!",
    ...
    public static final String ONLYPLAYER = generateError("Only players can run this command!");
    public static final String FINISHSTREAM = toColour("&6%d has finished streaming!");
    public static final String FINISHRECORD = toColour("&6&d has finished recording!");
    public static final String STARTSTREAM = toColour("%d has started streaming at - %d");
